...
rsync -arvzSH --include="*.cpp" --include="*.hpp" --include="SConstruct" --include="*.lua" --include="*/" --exclude="*" ~/Projects/tribal/ cognizance@Luke:~/Projects/tribal/ && ssh cognizance@Luke "cd Projects/tribal/; scons -j8"
